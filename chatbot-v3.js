(function() {
    ...
    chatContainer.innerHTML = `
        <div id="chat-button" style="background: #f4ede7; color: #151515; width: 45px; height: 45px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; border: 1px solid #ccc; box-shadow: 0 4px 10px rgba(0,0,0,0.2); font-size: 20px; position: absolute; bottom: 0; right: 0; transition: transform 0.2s ease; z-index: 2147483647 !important;">
            📦
        </div>
        <div id="chat-window" style="display: none; position: absolute; bottom: 0; right: 0; width: 260px; border: 1px solid #ccc; background: white; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); overflow: hidden; flex-direction: column; z-index: 2147483647 !important;">
