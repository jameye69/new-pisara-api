(function() {
    ...
    chatContainer.innerHTML = `
        ...
        <div id="chat-window" style="display: none; position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 260px; border: 1px solid #ccc; background: white; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); overflow: hidden; flex-direction: column; margin-left: -40px;">
    ...
    Object.assign(chatContainer.style, {
        ...
        bottom: '85px', 
        right: '13px',
        width: '45px', // Säiliön leveys sama kuin napin
        zIndex: '10000',
